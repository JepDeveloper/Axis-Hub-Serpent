if game.PlaceId == 155615604 then -- Prison Life
    ...
    local Window = Library.CreateLib("Axis hub V2 - Prison Life", "Serpent")
    ...
    local SettingsSection = Settings:NewSection("Themes")

    SettingsSection:NewToggle("Serpent theme", "Changes the theme to serpent", function(state)
        if state then
            print("Toggle On")
        else
            print("Toggle Off")
...
elseif game.PlaceId == 3956818381 then -- Ninja Legends
    ...
    local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/xHeptc/Kavo-UI-Library/main/source.lua"))()
    local Window = Library.CreateLib("Axis Hub V2 - Ninja Legends", "Serpent")
...
if game.PlaceId == 286090429 then --arsenal
    ...
    local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/xHeptc/Kavo-UI-Library/main/source.lua"))()
    local Window = Library.CreateLib("Axis Hub V2 - Arsenal", "Serpent")
...
if game.PlaceId == 1004691966 then
    local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/xHeptc/Kavo-UI-Library/main/source.lua"))()
    local Window = Library.CreateLib("Axis Hub V2 - Solera hotels", "Serpent")
